        ...
        <div class="w-100">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <x-form-input type="date" id="start_date" name="start_date"
                            wire:model.defer="overtime.start_date" />
                    ...
                    <div class="col-md-6">
                        ...
                        <x-form-input type="date" id="end_date" name="end_date"
                            wire:model.defer="overtime.end_date" />
            ...
            <div class="mb-3">
                ...
                <textarea id="result" name="result" class="form-control"
                    wire:model.defer="overtime.result"></textarea>
                <x-form-error key="overtime.result" />
            </div>
            <div class="mb-3">
                <x-form-label id="user_id_approver" label='Penyetuju' />
                <select id="user_id_approver" name="user_id_approver" class="form-control"
                    wire:model.defer="overtime.user_id_approver">
