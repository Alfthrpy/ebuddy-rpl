...
class EmployeeCreateForm extends Component
{
    ...
    public function mount()
    {
        ...
        $this->roles = Role::all();
        $this->employees = [['name' => '', 'email' => '', 'phone' => '', 'password' => '', 'role_id' => User::PEGAWAI_ROLE_ID, 'position_id' => $this->positions->first()->id]];
    }
    ...
    public function saveEmployees()
    {
        ...
        redirect()
            ...
            ->with('success', "Ada ($affected) data karyawaan yang berhasil ditambahkan.");
    }
